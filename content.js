...
const alphabetDescription = /*html*/ `Арабское письмо пишется справа налево.
Краткие гласные (а их в арабском языке три:
${redStr`а`} - "фатха" (${redStr`ــَــ`}), ${redStr`и`} - "кясра" (${redStr`ــِــ`}), ${redStr`у`} - "дамма" (${redStr`ــُــ`}))
в письме выражаются особыми значками (огласовками), которые пишутся над или под согласной буквой,
при этом гласные читаются после согласных. Отсутствие гласного (закрытый слог) также имеет свой значок - "сукун" (<span class="red">ــْــ</span>).`
